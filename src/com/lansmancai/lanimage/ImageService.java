...
import com.lansmancai.lanimage.tool.AbstractTool;
...
public class ImageService {
	...
	public void repaint(Graphics g, BufferedImage bufferedImage) {
		...
		System.out.println((int) screenSize.getWidth() * 10);
		System.out.println((int) screenSize.getHeight() * 10);
